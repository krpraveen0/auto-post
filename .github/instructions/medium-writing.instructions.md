...
- Convert display equations to Notion-native `$ ... $` blocks and inline
  equations to Notion's `# Medium Writing Instructions
...
- Notion may be the collaborative drafting and reader-preview surface.
- Markdown in the repository is the portable, reviewable canonical snapshot.
Equation`# Medium Writing Instructions
